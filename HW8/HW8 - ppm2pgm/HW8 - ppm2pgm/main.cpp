//  Mark Billingsley
//  CS201, Spring 2021
//  HW8 - PPM2ASCII / ASCIIART
//  This program takes a PPM file and converts it to ASCII art.  Basically all the work is done in class functions.
...
// default constructor
    RGBImage() : _xres(0), _yres(0), _maxval(0) {
        cout << "Default constructor called: RGBImage variable created w/o passing argument.";
        cout << endl;}
